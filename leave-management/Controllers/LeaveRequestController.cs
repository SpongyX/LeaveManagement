...
namespace leave_management.Controllers
{
    ...
    public class LeaveRequestController : Controller
    {
        ...
        public async Task<ActionResult> Create(CreateLeaveRequestVM model)
        {
            ...
            try
            {
                //var startD = Convert.ToDateTime(model.StartDate).ToString("dd/MM/yyyy");
                //var startDate = Convert.ToDateTime(startD);
                //    //DateTime.ParseExact(model.StartDate, "dd/MM/YYYY", new CultureInfo("en-GB"));
                //var endD = Convert.ToDateTime(model.EndDate).ToString("dd/MM/yyyy");
